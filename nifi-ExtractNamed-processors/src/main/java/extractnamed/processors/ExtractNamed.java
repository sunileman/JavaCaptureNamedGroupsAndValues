 ...
 */
package extractnamed.processors;
...
public class ExtractNamed extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        for (final Map.Entry<String, Pattern> entry : patternMap.entrySet()) {
            ...
            while (matcher.find()) {
                ...
                for (String groupName : ExtractNamed.getNamedGroupCandidates(entry.getValue().pattern())) {
                    final String key = new StringBuilder(baseKey).append(".").append(groupName).toString();
